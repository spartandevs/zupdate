<?php namespace App\Http\Controllers\Api\message;
...
class MessageController extends Controller {
	...
	public function send_message(Request $request)
	{
		...
		if(!$this->check_receiver_if_exists_by_username($receiver)){
	...
	public function check_receiver_if_exists_by_username($username){
